...
\begin{frame}{Matplotlib - Example}
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth]{/workspaces/python_course/slides/five/figures/example_1.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}{Matplotlib - Example}
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth]{/workspaces/python_course/slides/five/figures/example_2.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}{Matplotlib - Example}
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth]{/workspaces/python_course/slides/five/figures/myplot.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}{Debugging - HowTo}
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth]{/workspaces/python_course/slides/five/figures/Screenshot 2023-11-27 163952.png}
    \end{figure}
\end{frame}
...
\begin{frame}{Debugging - HowTo}
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth]{/workspaces/python_course/slides/five/figures/Screenshot 2023-11-27 165218.png}
    \end{figure}
\end{frame}
